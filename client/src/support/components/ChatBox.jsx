...
//   // Auto-scroll to bottom when a new reply comes in
//   useEffect(() => {
...
//       <div 
//         ref={scrollRef}
//         className="flex-1 overflow-y-auto p-6 space-y-6 no-scrollbar min-h-[400px]"
//       >
//         {messages.length === 0 ? (
//           <div className="h-full flex flex-col items-center justify-center opacity-40">
//             <div className="w-16 h-16 bg-white/5 rounded-full mb-4 animate-pulse"></div>
//             <p className="font-serif italic text-sm">Waiting for connection...</p>
//           </div>
//         ) : (
...
//           />
//           <button className="bg-orange-600 hover:bg-orange-500 text-white font-bold py-2 px-6 rounded-xl text-xs uppercase tracking-widest transition-all shadow-lg active:scale-95">
//             Send
//           </button>
//         </div>

...
//     // This is where you would call your API (e.g., axios.post('/api/tickets', formData))
//     console.log("Ticket Submitted Successfully:", formData);
//     alert("Ticket Submitted! Our consultants will review it shortly.");
...
//         <button 
//           type="submit"
//           className="w-full bg-orange-600 text-white font-black py-4 rounded-2xl text-xs uppercase tracking-[0.3em] hover:bg-orange-500 hover:shadow-[0_0_30px_rgba(234,88,12,0.3)] transition-all transform active:scale-95 shadow-xl"
//         >
//           Submit Ticket
//         </button>
//       </div>
